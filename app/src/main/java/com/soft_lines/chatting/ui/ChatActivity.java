...
import com.soft_lines.chatting.adapters.ChatAdapter;
import com.soft_lines.chatting.databinding.ActivityChatBinding;
import com.soft_lines.chatting.firebase.MessagingService;
import com.soft_lines.chatting.models.ChatMessage;
import com.soft_lines.chatting.models.User;
import com.soft_lines.chatting.network.ApiClient;
import com.soft_lines.chatting.network.ApiServices;
...
public class ChatActivity extends BaseActivity {
    ...
    private void init() {
        ...
        adapter = new ChatAdapter(chatMessages, getBitmapFromEncodedString(receiverUser.image),
        ...
        db.collection(Constants.KEY_COLLECTION_USERS).document(
            ...
            if (value != null) {
                ...
                if (receiverUser.image == null) {
                    ...
                    adapter.setReceiverProfileImage(getBitmapFromEncodedString(receiverUser.image));
    ...
    private void loadReceiverUserDetails() {
        ...
        if (receiverUser == null) {
            receiverUser = MessagingService.sendUser;
        }
    ...
    private void checkForConversion() {
        if (chatMessages.size() != 0) {
            checkForConversionRemotely(preferencesManager.getString(Constants.KEY_USER_ID), receiverUser.id);
            checkForConversionRemotely(receiverUser.id, preferencesManager.getString(Constants.KEY_USER_ID));
        }
    }
